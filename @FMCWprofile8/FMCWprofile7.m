classdef FMCWprofile7
    ...
    properties
        ...
        ndaq % number of daq file processed results to save together
        maxP % maximum row number to save in PDATA
    ...
    methods
        % constuctor function
        function rd=FMCWprofile7(location,data_dir,inc_angle)
            if nargin==0
                rd.location=' ';
                rd.data_dir=' ';
                rd.inc_angle=0;
