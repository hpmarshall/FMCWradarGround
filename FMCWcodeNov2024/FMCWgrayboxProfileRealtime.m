...
ch=addAnalogInputChannel(s,dinfo(1).ID,[0 1 2],'Voltage') % add channels 0 and 1
ch(2).Range=[-1 1];
ch(3).Range=[-1 1];
...
zmin=-100; zmax=-20; % PSD range in dB to plot
depthmin=0;depthmax=250; % min/max depth to plot
