...
chan=addchannel(AI,[7 5 4]); % add 2 channels, ramp, radar input (far from each other)
AI.Channel(1).InputRange=[0 10]; % set input range for ramp
AI.Channel(2).InputRange=[-5 5]; % set input range of radar input
AI.Channel(3).InputRange=[-5 5]; % set input range of radar input
...
AI.SamplesPerTrigger=90000; %nsamptrace*20; % samples per trace to collect
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
