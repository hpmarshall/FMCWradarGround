function [RMSE,Rval,RadarDepth] = radarFit2(rmod2,TWT,PDATA3,rmod,MPdepth,gthresh,sthresh)
...
winsize2=10; % window size for median
...
for n=1:length(rmod)
    ...
    if sum(IxG)>0 && sum(IxS)>0
        ...
        RadarDepth(n)=(Gloc-Sloc)*2.25e10; % estimated depth (find other factor of 2!)
    end
end
